...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        ...
        self.entity_list.extend(
            EntityFactory.get_entity(self.name.replace(" ", "") + 'Bg'))
    ...
    def run(self, player_score: list[int]):
        ...
        while True:
            ...
            for ent in self.entity_list:
                ...
                if ent.name == 'Player1':
                    self.level_text(16, f'Player1 - Health: {ent.health}  | Score: {ent.score}', C_GREEN, (10, 25))
                if ent.name == 'Player2':
                    self.level_text(16, f'Player2 - Health: {ent.health}  | Score: {ent.score}', C_CYAN, (10, 45))
